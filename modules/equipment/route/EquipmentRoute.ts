...
class EquipmentRoute implements IEquipmentRoute {
	private equipmentController: IEquipmentController;
	private role = UserRole.ENGINEER;

	constructor(equipmentController: IEquipmentController) {
	...
	configureRoutes(router: Router): void {
		...
		router.post("/hours", verifyRole(this.role), this.equipmentController.addUseHours);
